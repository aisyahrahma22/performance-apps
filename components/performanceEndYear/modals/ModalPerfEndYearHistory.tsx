...
import PerfFormTypeTab from '../../performanceMidYear/components/PerfFormTypeTab';
...
import CategoryPerformanceSection from '../../performanceMidYear/components/CategoryPerformanceSection';
import { find } from 'lodash';

interface ModalPerfEndYearHistoryProps {
  id: string;
  isOpen: boolean;
  closePress: any;
  openPress?: any;
...
function ModalPerfEndYearHistory({
  id,
  isOpen,
  closePress,
  activeFormTypeId,
  ...
  dataTab,
  isEndYear = false,
}: ModalPerfEndYearHistoryProps) {
  const { perfEmp, perfForm, isLoading } = usePerfEndYearEditForm({
    id,
    onSubmit: null,
    onClose: closePress,
  });
...
export default ModalPerfEndYearHistory;
