...
// import usePerformanceWorkflowEmployeeEdit from '../../lib/data/performanceWorkflowEmployee/usePerformanceWorkflowEmployeeEdit';
import { PFWorkflowTypeEnum } from '../../lib/enums/PerformanceEnum';
import usePerformanceWorkflowEmployee from '../../lib/data/performanceWorkflowEmployee/usePerformanceWorkflowEmployee';
import usePerformanceWorkflowEmployeeEdit from '../../lib/data/performanceWorkflowEmployee/usePerformanceWorkflowEmployeeEdit';
import { getEmployees } from '../../lib/data/employee/useEmployees';

interface ModalPerformanceWorkflowEmployeeEditProps {
  id: string;
  isOpen: boolean;
  closePress: any;
  openPress?: any;
...
const ModalPerformanceWorkflowEmployeeEdit = ({
  id,
  isOpen,
  closePress,
}: ModalPerformanceWorkflowEmployeeEditProps) => {
  ...
  const {
    performanceWorkflowEmployeeEdit,
    isPerformanceWorkflowEmployeeEditLoading,
  } = usePerformanceWorkflowEmployeeEdit({
  ...
  const formikPFWorkflow = useFormik({
    ...
    onSubmit: (values) => {
      ...
      performanceWorkflowEmployeeEdit({ PFWorkflowEmp: result, id });
    },
...
export default ModalPerformanceWorkflowEmployeeEdit;
