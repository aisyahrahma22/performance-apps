...
interface UsePerfFinalEvalProps {
  onSuccess?: any;
}

const usePerfFinalEvalReport = (args: UsePerfFinalEvalProps = {}) => {
  ...
  return {
    fetchPerfFinalEvalReport: fetch,
    isPerfFinalEvalReportLoading: isLoading,
  };
};

export default usePerfFinalEvalReport;
