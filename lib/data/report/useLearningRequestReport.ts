...
interface UseLearningRequestReportProps {
  onSuccess?: any;
}

const useLearningRequestReport = (args: UseLearningRequestReportProps = {}) => {
  ...
  return {
    fetchLearningRequestReport: fetch,
    isLearningRequestReportLoading: isLoading,
  };
};

export default useLearningRequestReport;
