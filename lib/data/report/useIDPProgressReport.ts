...
interface UseIDPProgressReportProps {
  onSuccess?: any;
}

const useIDPProgressReport = (args: UseIDPProgressReportProps = {}) => {
  ...
  return {
    fetchIDPProgressReport: fetch,
    isIDPProgressReportLoading: isLoading,
  };
};

export default useIDPProgressReport;
