...
interface UseLearningBudgetReportProps {
  onSuccess?: any;
}

const useLearningBudgetReport = (args: UseLearningBudgetReportProps = {}) => {
  ...
  return {
    fetchLearningBudgetReport: fetch,
    isLearningBudgetReportLoading: isLoading,
  };
};

export default useLearningBudgetReport;
