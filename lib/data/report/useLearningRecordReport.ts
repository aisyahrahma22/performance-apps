...
interface UseLearningRecordReportProps {
  onSuccess?: any;
}

const useLearningRecordReport = (args: UseLearningRecordReportProps = {}) => {
  ...
  return {
    fetchLearningRecordReport: fetch,
    isLearningRecordReportLoading: isLoading,
  };
};

export default useLearningRecordReport;
