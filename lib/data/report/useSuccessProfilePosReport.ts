...
interface UseSuccessProfilePosReportProps {
  onSuccess?: any;
}

const useSuccessProfilePosReport = (
  args: UseSuccessProfilePosReportProps = {},
) => {
  ...
  return {
    fetchSuccessProfilePosReport: fetch,
    isSuccessProfilePosReportLoading: isLoading,
  };
};

export default useSuccessProfilePosReport;
