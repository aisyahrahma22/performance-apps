...
interface UseLearningBudgetApprovalDetailReportProps {
  onSuccess?: any;
}

const useLearningBudgetApprovalDetailReport = (
  args: UseLearningBudgetApprovalDetailReportProps = {},
) => {
  ...
  return {
    fetchLearningBudgetApprovalDetailReport: fetch,
    isLearningBudgetApprovalDetailReportLoading: isLoading,
  };
};

export default useLearningBudgetApprovalDetailReport;
