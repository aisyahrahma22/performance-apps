...
interface UseLearningPlotReportProps {
  onSuccess?: any;
}

const useLearningPlotReport = (args: UseLearningPlotReportProps = {}) => {
  ...
  return {
    fetchLearningPlotReport: fetch,
    isLearningPlotReportLoading: isLoading,
  };
};

export default useLearningPlotReport;
