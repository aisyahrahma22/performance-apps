...
interface UseLearningKnowledgeSharingReportProps {
  onSuccess?: any;
}

const useLearningKnowledgeSharingReport = (
  args: UseLearningKnowledgeSharingReportProps = {},
) => {
  ...
  return {
    fetchLearningKnowledgeSharingReport: fetch,
    isLearningKnowledgeSharingReportLoading: isLoading,
  };
};

export default useLearningKnowledgeSharingReport;
