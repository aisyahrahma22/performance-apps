...
interface UseListApproverPAReportProps {
  onSuccess?: any;
}

const useListApproverPAReport = (args: UseListApproverPAReportProps = {}) => {
  ...
  return {
    fetchListApproverPAReport: fetch,
    isListApproverPAReportLoading: isLoading,
  };
};

export default useListApproverPAReport;
