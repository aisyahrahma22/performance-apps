...
interface UseTalentProReadynessReportProps {
  onSuccess?: any;
}

const useTalentProReadynessReport = (
  args: UseTalentProReadynessReportProps = {},
) => {
  ...
  return {
    fetchTalentProReadynessReport: fetch,
    isTalentProReadynessReportLoading: isLoading,
  };
};

export default useTalentProReadynessReport;
