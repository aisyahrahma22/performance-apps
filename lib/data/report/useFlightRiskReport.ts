...
interface UseFlightRiskReportProps {
  onSuccess?: any;
}

const useFlightRiskReport = (args: UseFlightRiskReportProps = {}) => {
  ...
  return {
    fetchFlightRiskReport: fetch,
    isFlightRiskReportLoading: isLoading,
  };
};

export default useFlightRiskReport;
