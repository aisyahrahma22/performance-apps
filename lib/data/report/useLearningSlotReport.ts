...
interface UseLearningSlotReportProps {
  onSuccess?: any;
}

const useLearningSlotReport = (args: UseLearningSlotReportProps = {}) => {
  ...
  return {
    fetchLearningSlotReport: fetch,
    isLearningSlotReportLoading: isLoading,
  };
};

export default useLearningSlotReport;
