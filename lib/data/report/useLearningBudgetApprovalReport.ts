...
interface UseLearningBudgetApprovalReportProps {
  onSuccess?: any;
}

const useLearningBudgetApprovalReport = (
  args: UseLearningBudgetApprovalReportProps = {},
) => {
  ...
  return {
    fetchLearningBudgetApprovalReport: fetch,
    isLearningBudgetApprovalReportLoading: isLoading,
  };
};

export default useLearningBudgetApprovalReport;
