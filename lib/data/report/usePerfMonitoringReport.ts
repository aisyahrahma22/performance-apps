...
interface UsePerfMonitoringReportProps {
  onSuccess?: any;
}

const usePerfMonitoringReport = (args: UsePerfMonitoringReportProps = {}) => {
  ...
  return {
    fetchPerfMonitoringReport: fetch,
    isPerfMonitoringReportLoading: isLoading,
  };
};

export default usePerfMonitoringReport;
