...
interface UseLearningSessionReportProps {
  onSuccess?: any;
}

const useLearningSessionReport = (args: UseLearningSessionReportProps = {}) => {
  ...
  return {
    fetchLearningSessionReport: fetch,
    isLearningSessionReportLoading: isLoading,
  };
};

export default useLearningSessionReport;
