...
interface UseLNASkillReportProps {
  onSuccess?: any;
}

const useLNASkillReport = (args: UseLNASkillReportProps = {}) => {
  ...
  return {
    fetchLNASkillReport: fetch,
    isLNASkillReportLoading: isLoading,
  };
};

export default useLNASkillReport;
