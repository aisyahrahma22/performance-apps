...
interface UseHumanAssetReportProps {
  onSuccess?: any;
}

const useHumanAssetReport = (args: UseHumanAssetReportProps = {}) => {
  ...
  return {
    fetchHumanAssetReport: fetch,
    isHumanAssetReportLoading: isLoading,
  };
};

export default useHumanAssetReport;
