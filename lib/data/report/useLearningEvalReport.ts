...
interface UseLearningEvalReportProps {
  onSuccess?: any;
}

const useLearningEvalReport = (args: UseLearningEvalReportProps = {}) => {
  ...
  return {
    fetchLearningEvalReport: fetch,
    isLearningEvalReportLoading: isLoading,
  };
};

export default useLearningEvalReport;
